...
function page() {
  return (
    <div className="py-5 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-4">Privacy Policy Effective Date: 1/20/2025</h1>
      <p className="mb-4">
      This “Privacy Policy” explains how Manuel Orosco New Home Builder & Home Supplies Inc collects, uses, discloses, and otherwise processes personal data on behalf of our customers – typically, merchants (any, a “Merchant”) – in connection with our application, our phsyical location, which runs on the Clover Point of Sale system (“Clover POS”). This Privacy Policy does not apply to Company’s privacy practices in any other context.
...
This Privacy Policy is not a substitute for any privacy policy that a Merchant may be required to provide to their customers, personnel, or other individuals.</p>
      <h2 className="text-2xl font-semibold mb-2">1. Information Clover collects</h2>
      <p className="mb-4">
      ...
      Information that we collect when a customer for a Merchant makes a payment</h2>
      <p className="mb-4">
      ...
      In addition, we collect: personal information about the customer, such as name, email address, phone number, and other contact information; given voluntarily by the customer or the Merchant; and information about the customer’s preferences and experiences with the Merchant, such as purchase history, feedback, and other information provided by the customer or the Merchant.
      </p>
      <h2 className="text-2xl font-semibold mb-2">Additional information that customers of the Merchant provide through the Clover POS ancillary to a payment
      We may collect additional information ancillary to the payment. This information may include:</h2>
    <ul className="list-disc pl-5 mb-4">
      <li>Customers’ email address or phone number, such as when the customer chooses to receive an electronic receipt</li>
      <li>Customers’ marketing preferences, such as whether the customer wishes to receive marketing communications or newsletters</li>
      <li>Information about participating customers’ activity in a merchant loyalty program</li>
      <li>Customers’ physical address, where needed for delivery of goods or services</li>
      <li>Other information the customer provides, such as birthdate, interests or preferences, reviews, and feedback
      </li>
    </ul>
      <h2 className="text-2xl font-semibold mb-2">Other information the customer provides, such as birthdate, interests or preferences, reviews, and feedback</h2>
      <p className="mb-4">
      We may collect information about Merchants’ personnel and interactions
       with the Clover POS, such as clock-in and clock-out time and tips earned.
      ...
      <p className="mb-4">.
      We use the personal data we collect for or on behalf of Merchants, to provide our services and the functionality of our application: purchase in store.
      </p>
      <p className="mb-4">We may also use personal data for related internal purposes, including:</p>
      <ul className="list-disc pl-5 mb-4">
        <li>
        To provide information about the application, such as important updates or changes to the application and security alerts
        </li>
        <li>To measure performance of and improve the application
        </li>
        <li>To respond to inquiries, complaints, and requests for customer support </li>
      ...
      <ul className="list-disc pl-5 mb-4">
        ...
        <li>The platform on which our application runs, the Clover POS. You may view Clover’s Privacy Notice here.</li>
        <li>With third parties as a Merchant may direct</li>
        <li>With third party service providers that help us manage and improve the application</li>
...
Contact us
You may contact us with any questions, comments, or complaints, about this Privacy Policy or our privacy practices via: email at sales@manuelhomesupplies.com
      </p>
      <h2 className='mb-4'>Company is a data processor acting for and on behalf of the Merchant that has installed our application on their Clover POS. That Merchant is the controller of personal data that we process on its behalf. Clover is also a controller of personal data in some circumstances. Clover’s Privacy Notice is available at </h2>
    <a href="https://www.clover.com/privacy-policy." className='text-blue-500'> https://www.clover.com/privacy-policy.</a>
...
When we transfer personal data outside of Europe (or the UK) to countries not deemed by the European Commission to provide an adequate level of protection for personal data, we make the transfer pursuant to one of the following transfer mechanisms:
    ...
    <ul className='list-disc pl-5 mb-4'>
      <li>A contract approved by the European Commission (sometimes called “Model Clauses” or “Standard Contractual Clauses”);</li>
      <li>The recipient’s Binding Corporate Rules;</li>
      <li>The consent of the individual to whom the personal data relates; or</li>
      <li>Other mechanisms or legal grounds as may be permitted under applicable European law.</li>
    </ul>
    <p className='mb-4'>
    Data retention
...
<li>Call 732-713-3607</li>
    ...
    <p>We  do not sell, as defined under CCPA, your Personal Information to third parties.

In the preceding twelve (12) months, we have not sold any personal information.</p>
<h2 className='text-2xl font-semibold mb-2'>
Personal information that we collect, use and share
</h2>
<p> The chart below summarizes our collection, use and sharing of Personal Information during the last 12 months before the effective date of this Privacy Policy. We describe the sources through which we collect your Personal Information in section above titled The Personal Data We Collect, and describe the purposes for which we collect, use, sell and share this information in section above titled How We Use Your Personal Data and The Parties With Whom We Share Your Personal Data.</p>
  ...
  <tbody>
    ...
    <table className='w-full mb-4 '>
      ...
      <tbody>
        <tr>
          <td>Biometric Information</td>
          <td>An individual’s physiological, biological or behavioral characteristics, including DNA, that can be used, singly or in combination with each other or with other identifying data, to establish an individual’s identity. Imagery of the iris, retina, fingerprint, face, hand, palm, vein patterns, and voice recordings, from which an identifier template, such as a face print, a minutiae template, or a voiceprint, can be extracted, and keystroke patterns or rhythms, gait patterns or rhythms, and sleep, health, or exercise data that contain identifying information.</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Professional or Employment Information</td>
          <td>Information relating to a person's current, past or prospective employment or professional experience, and educational background.</td>
        </tr>
        <tr>
          <td>Protected Classification Characteristics</td>
...
<p>
  732-259-4200<br />
  sales@manuelhomesupplies.com<br />
